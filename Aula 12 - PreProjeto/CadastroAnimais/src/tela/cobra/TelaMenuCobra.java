...
public class TelaMenuCobra {
	...
	public void chamarTelaMenuCobra() {
        ...
        frameTelaMenuCobra.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        // Posicionar a janela no centro da tela
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        frameTelaMenuCobra.setLocation(dim.width / 2 - frameTelaMenuCobra.getSize().width / 2, 
                                     dim.height / 2 - frameTelaMenuCobra.getSize().height / 2);
